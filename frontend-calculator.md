...
2) [Современный учебник JavaScript](https://learn.javascript.ru/) - тут довольно много теоретической информации и под многими статьями есть задачки, которые рекомендуется решить. Нас интересуют первый 5 глав (не полностью, смотри скриншот ниже) и работа с ошибками из 10 главы.
3) [Codewars](https://www.codewars.com/) - много задачек для практики. Учитесь решать 8-6 kyu, не меньше (меньше - сложнее). На английском, но переводчик вам поможет. 
4) [MDN - JavaScript](https://developer.mozilla.org/ru/docs/Web/JavaScript) - Справочник по языку, самый адекватный и актуальный.
5) Гугл - основной интрумент для поиска информации.
